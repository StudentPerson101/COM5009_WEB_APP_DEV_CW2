        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalApiId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.Id);
                    table.CheckConstraint("CK_Movies_ReleaseYear", "ReleaseYear IS NULL OR ReleaseYear >= 1888");
                    table.CheckConstraint("CK_Movies_Runtime", "Runtime IS NULL OR Runtime > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewingHistoryItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ViewingHistoryItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ViewingHistoryItems_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_WatchlistItems_Status", "Status IN ('planned', 'watching', 'watched', 'dropped')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViewingHistoryItems_MovieId",
                table: "ViewingHistoryItems",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_ViewingHistoryItems_UserId",
                table: "ViewingHistoryItems",
                column: "UserId");
